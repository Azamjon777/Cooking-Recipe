...
import com.bun.cookingrecipe.databinding.FragmentFishDishesBinding
...
class FishDishesFragment : Fragment() {
    private lateinit var binding: FragmentFishDishesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFishDishesBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val foodList: List<FoodModel> = dataViewModel.foodList[2].listOfCategories
